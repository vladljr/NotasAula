...
public class Main {
    public static void main(String[] args) {
        ...
        do {
            System.out.println("\n============= MIDAS SISTEMA BANCÁRIO =============");
            System.out.println("Por favor, informe seu nome: ");
            // Atribui a próxima linha de strings como titular da Conta Corrente
            corrente.setTitular(sc1.nextLine());

            // Recupera a string de titular da Conta Corrente e a atribui como titular da Poupança
            ...
            switch (menu) {
                case 1:
                    do {
                        System.out.println("\n Bem-vindo, " + corrente.getTitular() + "!\n O saldo presente da sua CONTA CORRENTE é de : R$ " + corrente.getSaldo());
                        System.out.println("Que operação deseja realizar? \nDigite [1] para DEPOSITAR \nDigite [2] para SACAR \nDigite [3] para USAR CHEQUE ESPECIAL \nDigite [4] para EXIBIR DADOS DA CONTA \nDigite [0] para SAIR");
                        System.out.print("Opção desejada: ");
                ...
                case 2:
                    do {
                        System.out.println("\n Bem-vindo, " + poupanca.getTitular() + "!\n O saldo presente da sua CONTA POUPANÇA é de : R$ " + poupanca.getSaldo());
                        System.out.println("Que operação deseja realizar? \nDigite [1] para DEPOSITAR \nDigite [2] para SACAR \nDigite [3] para CALCULAR RENDIMENTOS \nDigite [4] para EXIBIR DADOS DA CONTA \nDigite [0] para SAIR");
                        System.out.print("Opção desejada: ");
